...
export const StickyScroll = ({
  ...
  useMotionValueEvent(scrollYProgress, "change", (latest) => {
    ...
    const activeIndex = Math.floor(latest / sectionHeight)
  ...
  return (
    <motion.div
      ...
      className="h-[30rem] overflow-y-auto flex justify-center relative space-x-12 rounded-md p-8"
      ref={ref}
    >
      ...
      <div
        ...
        className={cn("hidden lg:block h-80 w-96 rounded-md bg-white sticky top-10 overflow-hidden", contentClassName)}
      >
